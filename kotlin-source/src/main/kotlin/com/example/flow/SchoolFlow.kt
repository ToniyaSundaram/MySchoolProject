...
object SchoolFlow {
    ...
    class Initiator(val name: String,
                    val age: Int,
                    val id: Int,
                    val deo: Party) : FlowLogic<SignedTransaction>() {
        /**
        ...
        override fun call(): SignedTransaction {
            ...
            val schoolState = SchoolState(name, age, id,serviceHub.myInfo.legalIdentities.first(), deo)
            val txCommand = Command(SchoolContract.Commands.Create(), schoolState.participants.map { it.owningKey })
            val txBuilder = TransactionBuilder(notary)
                    .addOutputState(schoolState, School_CONTRACT_ID)
            ...
            val otherPartyFlow = initiateFlow(deo)
